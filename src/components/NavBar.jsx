...
export function NavBar() {
	...
	return (
		<nav className="fixed left-0 right-0 top-0 z-50 mx-auto mt-1 flex h-12 w-11/12 max-w-3xl  items-center  justify-center gap-5  rounded-full  bg-[#000021]/50 lg:px-5 ">
			<NavLink
				to="/"
